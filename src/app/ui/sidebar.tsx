        ...
        <nav className="space-y-4   h-full">
          ...
          <p>Leerjaar 3</p>
            ...
            <ul className="text-white space-x-2 flex flex-row pt-2">
                <li className=" border-white border-2 w-1/2 my-auto p-1 rounded-xl active:bg-white"><a href="mailto:Silloffeld@gmail.com" >Email mij prive</a></li>
                <li className=" border-white border-2 w-1/2 my-auto p-1 rounded-xl active:bg-white"><a href="mailto:0362067@student.rocvantwente.nl">mijn school mail</a></li>
            </ul>
            </div>
        </nav>
      </aside>
